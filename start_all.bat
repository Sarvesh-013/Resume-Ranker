...
cd /d D:\Projects\Resume_Project
start cmd /k "call resume\Scripts\activate && python resume_processor.py"

:: Wait for a few seconds
timeout /t 5 /nobreak >nul

echo Starting Web Application...
start cmd /k "call resume\Scripts\activate && python app.py"
